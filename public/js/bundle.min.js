!function () {
    ...
    function n() {
        ...
        if ((r || i.length) && (!function (t, o) {
            ...
            t = gsap.timeline();
            var s = document.documentElement.dir, l = "rtl" === s ? "reverse" : "from",
                c = "rtl" === s ? "from" : "reverse", u = {
                    x: {
            ...
            t.set(a, {autoAlpha: 1}).set(d, {clipPath: u.x[l]}).set(m, {clipPath: u.x[c]}).set(f, {clipPath: u.c[l]}).set(p, {clipPath: u.c[c]}), a.forEach((function (e) {
                d.includes(e) || m.includes(e) ? t.to(e, {clipPath: u.x.to}) : f.includes(e) ? t.to(e, {clipPath: u.c.to[l].st1}).to(e, {clipPath: u.c.to[l].st2}).to(e, {clipPath: u.c.to[l].st3}) : p.includes(e) && t.to(e, {clipPath: u.c.to[c].st1}).to(e, {clipPath: u.c.to[c].st2}).to(e, {clipPath: u.c.to[c].st3})
            })), n.add(t)
        }
        i.length && (o = gsap.timeline(), i.forEach((function (e) {
            o.from(e, {autoAlpha: 0}).from(e, {scale: .2}, "<")
        })), n.add(o, "< +=0.5"))
    }

    var r = document.getElementById("testimonials");
    var i = document.querySelector(".ajaxLoader"), a = new Proxy([], {
        set: function (e, t, o) {
            return e[t] = o, c(), !0
    ...
    function d(e) {
        var t = e.id, o = e.type, n = e.msg, r = e.autoHide;
        if (u) {
            var i = u.children.length, a = t || "notify_".concat(Date.now()).concat(i), s = function () {
    ...
    function p() {
        var e, t, o, n = document.querySelector(".contact-section .contact__form"),
            r = n.querySelector('input[name="name"]'), i = n.querySelector('input[name="email"]'),
            a = n.querySelector('input[name="phone"]'), c = n.querySelector('textarea[name="message"]'), u = {
        ...
        "" === r.value ? (u.name.required = !0, d({
            ...
            }))) : "error" === t && d({type: "danger", msg: e.dataset.errMsg}), l(), console.log(t)
        })).catch((function (e) {
    ...
    function g() {
        var e;
        gsap.registerPlugin(ScrollTrigger), function () {
            var e = document.querySelector(".scroll-to-top");
            if (e) {
                var t = e.dataset.showAt, o = e.querySelector("path"), n = o.getTotalLength();
                gsap.from(e, {
                    ease: "none",
                    duration: .3,
                    autoAlpha: 0,
            ...
            if (e.length) {
                ...
                e.forEach((function (e, o) {
                    var n = 0 === o ? "" : "< +=0.2";
                    t.from(e, {autoAlpha: 0}, n).from(e, {y: 50}, "<")
                }))
            }
        }(), function () {
            ...
            e.forEach((function (e) {
                gsap.timeline({
                    ...
                    autoAlpha: 0,
                    y: 50
                }, "-=0.2").from(e.querySelectorAll("h2 ~ *"), {autoAlpha: 0, y: 50, stagger: .2}, "-=0.2")
            }))
            ...
            autoAlpha: 0,
            top: 50
        }).from(".testimonials-section .section-title .title", {autoAlpha: 0, y: 50}, "< +=0.2"), function () {
            if (r) {
                var e = gsap.utils.toArray(".testimonials-section .testimonials__item"), t = gsap.timeline({
                    scrollTrigger: {
                ...
                e.forEach((function (e, o) {
                    var n = 0 === o ? "" : "< +=0.2";
                    t.from(e, {autoAlpha: 0}, n).from(e, {scale: .2}, "<")
                }))
            }
        }(), function () {
            ...
            if (e.length) {
                ...
                e.forEach((function (e, o) {
                    var n = 0 === o ? "" : "< +=0.2";
                    t.from(e, {autoAlpha: 0}, n).from(e, {y: 50}, "<")
                })), t.from(".contact-section .contact__social__item", {autoAlpha: 0}).from(".contact-section .contact__social__item", {
                    y: 50,
                    stagger: .2
                }, "<")
            }
        ...
        }).from(".contact-section .contact__form", {autoAlpha: 0, scale: .7})
    }
    ...
    function v() {
        ...
        if (e) {
            var t = window.pageYOffset, o = !(t >= 100), n = t > 100 && t > y;
    ...
    function _() {
        ...
        document.documentElement.dataset.mode = e, h && (h.dataset.mode = e), localStorage.setItem("abdoSavedMode", e)
    }
    ...
    var A = document.querySelector(".header .navbar"), q = document.querySelector(".header .hamburgerBtn");
    ...
    function x() {
        w && VanillaTilt.init(w.querySelectorAll(".portfolio__item"), {max: 8, speed: 400, glare: !0, "max-glare": .3})
    }

    function k(t) {
        var o = w.querySelectorAll(".portfolio__filters__btn"), n = t.textContent.toLowerCase();
    ...
    function P(t) {
        ...
        })), T()) : d({type: "danger", msg: o, autoHide: !0}), l()
    }
    ...
    document.addEventListener("DOMContentLoaded", (function () {
        ...
        !function () {
            var t = 0, o = document.querySelector(".preloader");
            if (o) {
                var n = o.querySelector(".preloader__content"), r = e(document.images), i = r.length, a = function () {
                    o.setAttribute("style", "--loading-percentage: 100%"), gsap.timeline().set(".hide-in-preloading", {autoAlpha: 1}).to(n, {
                        delay: .5,
                        autoAlpha: 0
                    }).to(o, {y: "-100%", duration: 1, ease: "expo.in"}, "-=0.5").set(o, {autoAlpha: 0})
                }, s = function () {
                    t++;
                    var e = 100 / i * t << 0;
        ...
        })), v(), (s = localStorage.getItem("abdoSavedMode")) ? _(s) : window.matchMedia ? window.matchMedia("(prefers-color-scheme: dark)").matches ? _("dark") : _("light") : _(), window._toggleAppMode = b, window._offCanvasMenuToggle = L, window._offCanvasMenuClose = S, document.addEventListener("keyup", (function (t) {
        ...
        })), window._scrollToTop = o, new GLightbox({autoplayVideos: !1}), document.querySelectorAll("[data-tooltip]").forEach((function (e) {
        ...
        })), window._filterPortfolioItems = k, window._loadMorePortfolioItems = P, w && e(E).slice(70).forEach((function (e) {
